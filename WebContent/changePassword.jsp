		...
		<div class='container cont'>
			...
			<form class='form' method='post' action='ChangePassword'>
				<div class='form-group'>
					<label for='currPassword'>Enter your current password:</label>
					<input class='form-control' type='password' id='currPassword' name='currPass' placeholder='Current Password' />
				</div>
				<div class='form-group'>
					<label for='newPassword'>Enter a new password:</label>
					<input class='form-control' type='password' id='newPassword' name='newPass' placeholder='New Password' />
				</div>
				<div class='form-group'>
