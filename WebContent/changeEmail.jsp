			...
			<div class='col-sm-6'>
				...
				<form class='form' method='post' action='ChangeEmail'>
					<div class='form-group'>
						<label for='currEmail'>Enter your current email:</label> <input
							class='form-control' type='email' id='currEmail' name='currEmail'
							placeholder='Current Email' required />
					</div>
					<div class='form-group'>
						<label for='newEmail'>Enter a new email:</label> <input
							class='form-control' type='email' id='newEmail' name='newEmail'
							placeholder='New Email' required />
					</div>
					<div class='form-group'>
						<label for='conEmail'>Confirm new email:</label> <input
							class='form-control' type='email' id='conEmail' name='conEmail'
